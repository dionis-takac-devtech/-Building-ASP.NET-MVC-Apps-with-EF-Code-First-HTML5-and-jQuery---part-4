...
{
    public class MarketsAndNewsRepository : RepositoryBase<AccountAtAGlance>, IMarketsAndNewsRepository
    {
        ...
        private OperationStatus DeleteMarketIndexRecords(AccountAtAGlance context)
        {
            try
            {
