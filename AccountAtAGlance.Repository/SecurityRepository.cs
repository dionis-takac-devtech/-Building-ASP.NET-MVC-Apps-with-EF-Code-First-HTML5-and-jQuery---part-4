...
namespace AccountAtAGlance.Model.Repository
{
    public class SecurityRepository : RepositoryBase<AccountAtAGlance>, ISecurityRepository
    {
        ...
        private static OperationStatus InsertSecurities(List<Security> securities, AccountAtAGlance context)
        {
            foreach (var security in securities)
            {                        
        ...
        private OperationStatus InsertExchanges(IEnumerable<string> exchanges, AccountAtAGlance context)
        {
            //Insert Exchanges
        ...
        private OperationStatus DeleteSecurityRecords(AccountAtAGlance context)
        {
